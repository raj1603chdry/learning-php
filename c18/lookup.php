...
<html>
  ...
  <body>
    ...
    <?php
      ...
      //choose stock to lookup
      $symbol = 'GOOG';
      echo '<h1>Stock Quote for '.$symbol.'</h1>';

      $url = 'http://download.finance.yahoo.com/d/quotes.csv?s='.$symbol.'&e=.csv=&f=sl1dt1c1ohgv';
      ...
      // acknowledge source
      echo '<p>This information was retrieved from <br /><a href="'.$url.'"</a>.</p>';
