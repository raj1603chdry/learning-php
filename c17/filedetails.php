  ...
  <body>
    ...
    <?php
      ...
      if (!isset($_GET['file'])) {
        ...
        $uploads_dir = '/Applications/XAMPP/xamppfiles/htdocs/uploads/';

        // striping off directory information for security
        ...
        echo 'File Permission: '.decoct(fileperms($safe_file)).'<br />';
