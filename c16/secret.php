...
<html>
  ...
  <body>
    ...
    <?php
  } else if (($_POST['name'] == 'user') && ($_POST['password'] == 'password')) {
        // visitor username and password combination are correct
        echo "<h1>Here it is!</h1><p>I bet you are glad you can see this secret page.</p>";
      } else {
        // visitor's username and password combination is not correct
        echo "<h1>Go Away!</h1><p>You are not authorised to use this resource.</p>";
      }
